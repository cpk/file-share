...
public class editShare extends HttpServlet {
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res) throws IOException {
    	...
    	if(check){
	    	...
	    	String keyShare = req.getParameter("keyShare");
